...
export const metadata: Metadata = {
  title: "CannaMed | Premium Medical Cannabis Dispensary",
  description: "Trusted local source for lab-tested medical cannabis products. Expert consultation and premium wellness solutions.",
  keywords: "medical cannabis, cannabis dispensary, CBD products, wellness, local medicine shop",
  metadataBase: new URL("https://cannamed.com"),
  alternates: {
    canonical: "https://cannamed.com"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "CannaMed | Premium Medical Cannabis",
    description: "Trusted medical cannabis dispensary with lab-tested products and expert staff",
    type: "website",
    siteName: "CannaMed",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764176389643-9wvosebt.jpg",
        alt: "CannaMed Premium Medical Cannabis"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "CannaMed | Medical Cannabis Dispensary",
    description: "Premium lab-tested cannabis products with expert consultation",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764176389643-9wvosebt.jpg"]
  }
};
